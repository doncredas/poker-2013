...
public final class Icone {
	...
	public static ImageIcon tredici = new ImageIcon(Carte.getAbsolutePath() + "\\13.png");// Asso di quadri
	...
	public static ImageIcon ventisei = new ImageIcon(Carte.getAbsolutePath() + "\\26.png");// Asso di fiori
	...
	public static ImageIcon trentanove = new ImageIcon(Carte.getAbsolutePath()+ "\\39.png");// Asso di picche
	 ...
	 * Bisogna assicurare che il codice inserito sia compreso tra 0 e 51.
	 */
